...
# end snippet sequence_loss


# start snippet perplexity
def perplexity(loss: float) -> float:
    return math.exp(loss)
# end snippet perplexity


# start snippet loss_grad
def softmax_cross_entropy_grad(logits: Sequence[float], true_id: int) -> Vector:
    grad = softmax(logits)
    grad[true_id] -= 1.0
    return grad
# end snippet loss_grad
# end snippet loss


# start snippet training
# start snippet sgd_update_scalar
def sgd_update_scalar(weight: float, gradient: float, learning_rate: float) -> float:
    return weight - learning_rate * gradient
# end snippet sgd_update_scalar


# start snippet linear_backward
...
# end snippet linear_backward


# start snippet accumulate_gradients
def accumulate_gradients(gradients: Sequence[Matrix]) -> Matrix:
    ...
    return total
# end snippet accumulate_gradients


# start snippet sgd_update_matrix
...
# end snippet sgd_update_matrix
# end snippet training
