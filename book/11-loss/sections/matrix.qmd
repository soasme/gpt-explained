...
Figure @fig-ch11-matrix-loss shows cross-entropy loss as softmax probability followed by the negative log of the true-token probability.

![Cross-entropy loss](images/ch09_loss.png){#fig-ch11-matrix-loss fig-alt="Cross-entropy loss: logits → softmax → negative log of true-token probability"}
