...
*Training:* Given a sequence $[t_1, t_2, \ldots, t_n]$, the model predicts all next tokens simultaneously (thanks to causal masking): $P(t_2|t_1), P(t_3|t_1,t_2), \ldots$.
...
3. Sample or $\mathrm{argmax}$ → $t_{n+1}$
