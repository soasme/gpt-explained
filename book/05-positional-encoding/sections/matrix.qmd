...
\omega_1 &= 1 / 10000^{2/8} \approx 0.1 \\
\omega_2 &= 1 / 10000^{4/8} = 0.01 \\
\omega_3 &= 1 / 10000^{6/8} \approx 0.001
\end{aligned}
$$
...
Notice: dimension 0-1 (high frequency) changes dramatically between positions.
Dimension 6-7 (low frequency) barely changes.
Together they form a *unique fingerprint* for each position.
...
Figure @fig-ch05-matrix-pe-heatmap shows the sinusoidal positional encoding values as a heatmap over positions and dimensions.

![Sinusoidal positional encoding heatmap](images/ch03_pe_matrix.png){#fig-ch05-matrix-pe-heatmap fig-alt="Sinusoidal positional encoding heatmap"}
