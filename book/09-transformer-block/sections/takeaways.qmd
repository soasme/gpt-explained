...
The last step: turn the final vector for position `T` into a probability distribution over the vocabulary — that is *vocabulary projection* in @sec-ch10-vocab-projection.
:::
