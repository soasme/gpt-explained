...
Figure @fig-ch13-update-training shows gradients flowing backward from the loss through each layer while weights are updated.

![Backpropagation and weight updates](images/ch13_training.png){#fig-ch13-update-training fig-alt="Backpropagation: gradient flowing from loss backward through each layer, updating weights"}
